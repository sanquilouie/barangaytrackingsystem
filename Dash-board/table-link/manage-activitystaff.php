    ...
    <div class="card">
       <div class="card-header">
            <h3 class="card-title" style="float: right;"><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-activity"> Add Activity</button>
             <?php include 'modal/add_activity2.php';?>
        </div>
            ...
            <tbody>
                 <?php
                    ...
                    <tr>
                        ...
                        <td>
                         <div class="d-flex"><div class="flex-1"> <button class="btn btn-info btn-sm acty" data-act="<?= htmlentities($activity['id']); ?>">Edit</button></div></div>
                         </td>

                    </tr>
                    <?php } 
                     ?>
                     <?php include 'modal/edit-activity2.php'; ?>
