    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
         <a href="table-link/Myprofile3.php" class="dropdown-item">
            <i class="fas fa-address-card mr-2"></i>My Profile
          </a>
          <div class="dropdown-divider"></div>
          <a href="table-link/Changepassword3.php" class="dropdown-item">
...
<!-- 
 ...
 -->
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/Manage-blotterstaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Blotter</p>
                </a>
              </li>
        ...
        <!--   <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/manage-CertficateOfresidencystaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/manage-Brgybusinessclearance.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Brgy. Business Clearance</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/Manage-Medicalcertificatestaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
 ...
 -->
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/manage-activitystaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-12 col-sm-6 col-md-6">
           ...
           <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <?php
                 require_once '../Private/conn/db-connection.php';
                 $activityRows = $db->query('SELECT COUNT(*) FROM tblactivity')->fetchColumn(); 
                ?>
              <div class="info-box-content">
                <span class="info-box-text">TOTAL ACTIVITY</span>
                <span class="info-box-number"><?php echo number_format($activityRows);?></span>
