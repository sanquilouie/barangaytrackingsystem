<div class="modal fade" id="add-clearance">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-file-alt"></i> &nbsp;Add Permit Clearance</h4>
            ...
            <div class="modal-body">
                 <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                    <div class="row">
                      <div class="col-12">
                         <?php include 'controllers/add-clearance.php';?>
                      </div>
                    </div>
                  <div class="col-12">
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                        <label>Type of Business:</label>
                          <select type="text" class="form-control" name="typeOfBusiness">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" name="add-clearance">Add Clearance</button>
            </div>
                   </form>
         </div>
