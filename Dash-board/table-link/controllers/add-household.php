      ...
      $brgy_stat = new Brgy_status();
        if(ISSET($_POST['add-household'])){
            ...
            // ==========end audit trail==============
               ...
               $brgy_stat->add_household($householdno, $zone, $totalhousemembers, $headoffamily, $user, $ip, $host,  $logdate, $action);
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function () { swal("Add Household Successfully!","Message!","success");';
                  echo '}, 1000);</script>';
                  echo '<script type="text/javascript">';
