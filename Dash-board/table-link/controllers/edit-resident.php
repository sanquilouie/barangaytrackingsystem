    ...
    include_once('../../Private/class/brgy-information-system.php');
      $brgy_stat = new Brgy_status();
        if(ISSET($_POST['id'])){
               ...
               // $image_upload2 = "uploads/" .date("Ymd").time().'_'. basename($Get_image_name);
            ...
            // ==========audit trail==================
             $user = trim($_POST['user_name']);
              if(!empty($_SERVER["HTTP_CLIENT_IP"])){
               ...
               $action = "Updating Resident";    
            // ==========end audit trail==============



               $brgy_stat->edit_resident($lname, $fname, $mname, $bdate, $bplace, $age, $barangay, $zone, $totalhousehold, $differentlyabledperson, $relationtohead, $maritalstatus, $bloodtype, $civilstatus, $occupation, $monthlyincome, $householdnum, $lengthofstay, $religion, $nationality, $gender, $skills, $igpitID, $philhealthNo, $highestEducationAttainment, $landOwnershipStatus, $houseOwnershipStatus, $dwellingtype, $waterUsage, $lightningFacilities, $sanitaryToilet, $formerAddress, $remarks, $username, $password, $id, $user, $ip, $host,  $logdate, $action);
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function () { swal("Update Resident Successfully!","Message!","success");';
                  echo '}, 1000);</script>';
                  echo '<script type="text/javascript">';
