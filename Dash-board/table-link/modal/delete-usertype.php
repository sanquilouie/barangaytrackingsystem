<div class="modal fade" id="delete-usertype" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-user"></i> &nbsp;Delete User Type</h4>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" id="delete-u">Yes</button>
            </div>
          </form>
       </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        let btn = document.querySelector('#delete-u');
        btn.addEventListener('click', () => {
           ...
           // var delay = 100;
            ...
            $.ajax({
                url: 'controllers/delete-usertype.php',
                type: "POST",
                data: data,
                processData: false,
                contentType: false,
