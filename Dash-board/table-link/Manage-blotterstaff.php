    ...
    <div class="card">
       <div class="card-header">
            <h3 class="card-title" style="float: right;"><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-blotter"> Add Blotter</button>
             <?php include 'modal/add_blotter2.php';?>
        </div>
            ...
            <tbody>
                 <?php
                    ...
                    <tr>
                        ...
                        <td>
                         <div class="d-flex"><div class="flex-1"> <button class="btn btn-info btn-sm b_hold" data-btr="<?= htmlentities($blotters['id']); ?>">Edit</button></div></div>
                        </td>
                     </tr>
                    <?php } 
                     ?>           
                  <?php include 'modal/edit-blotter2.php'; ?>
