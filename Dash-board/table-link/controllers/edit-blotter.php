    ...
    include_once('../../Private/class/brgy-information-system.php');
      $brgy_stat = new Brgy_status();
        if(ISSET($_POST['id'])){
               ...
               $action = "Updating Blotter";    
            // ==========end audit trail==============


               $brgy_stat->edit_blotter($yearRecorded, $dateRecorded, $complainant, $cage, $caddress, $ccontact, $personToComplain, $page,$paddress,$pcontact,$complaint,$actionTaken,$sStatus,$locationOfincidence,$recordedby,$id, $ip, $host,  $logdate, $action);
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function () { swal("Update Blotter Successfully!","Message!","success");';
                  echo '}, 1000);</script>';
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function(){';
                  echo 'window.location = "/Barangay_Information_System/Dash-board/table-link/manage-blotter.php"';
                  echo '},2000)';
                  echo '</script>';
