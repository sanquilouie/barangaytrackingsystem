    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="Zoneleader-dashboard.php" class="nav-link active">
      ...
      <!--     <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/Manage-permitzleader.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Permit</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/Manage-permitclearancezleader.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<!-- 
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/manage-CertficateOfresidencyzoneleader.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="table-link/Financialcertificate.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
