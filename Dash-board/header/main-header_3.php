...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="dashboard-home.php" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="../staff-dashboard.php.php" class="nav-link active">
...
<!-- 
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Manage-permit.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Permit</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Manage-blotterstaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Blotter</p>
                </a>
              </li>
...
<!-- 
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manage-CertficateOfresidencystaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Financialcertificatestaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
 ...
 -->
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manage-activitystaff.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
