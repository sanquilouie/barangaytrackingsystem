        ...
        <div class="card-body">
            ...
            <tbody>
                 <?php
                    ...
                    <tr>
                        <td><?= ucfirst(htmlentities($staff['fullname'])); ?></td>
                        <td><?= ucfirst(htmlentities($staff['username'])); ?></td>
                        <td><?= ucfirst(htmlentities($staff['password'])); ?></td>
                        <td><?= ucfirst(htmlentities($staff['type'])); ?></td>
                       <td>
                         <div class="d-flex"><div class="flex-1"><div class="flex-1"> <button class="btn btn-danger btn-sm delete" data-ids="<?= htmlentities($staff['id']); ?>">Delete</button></div></div>
                         </td>
                    </tr>
                    <?php } 
                     ?>
                      <?php include 'modal/delete-userstaff.php'; ?>
                </tbody>
            </table>
        </div>
      </div>
