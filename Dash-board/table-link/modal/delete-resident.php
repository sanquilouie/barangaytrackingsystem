<div class="modal fade" id="delete-resident" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-user"></i> &nbsp;Delete Resident</h4>
            ...
            <div class="modal-footer justify-content-between">
              <input type="hidden" class="form-control" alt="user_name" name="user" value="<?php echo $f_name;?>">
                ...
                <button type="button" class="btn btn-primary" id="delete-re">Yes</button>
            </div>
          </form>
       </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        let btn = document.querySelector('#delete-re');
        btn.addEventListener('click', () => {
           ...
           // var delay = 100;
            ...
            $.ajax({
                url: 'controllers/delete-resident.php',
                type: "POST",
                data: data,
                processData: false,
                contentType: false,
